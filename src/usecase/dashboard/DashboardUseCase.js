...
export class DashboardUseCase {
     ...
     */
    static async getMandorDashboard(mandorId) {
        ...
        const totalLuasMingguIni = aktivitasMingguIni.reduce((sum, a) => sum + a.luasDikerjakan, 0);
        const totalPekerjaMingguIni = aktivitasMingguIni.reduce((sum, a) => sum + a.kehadiranPekerja.length, 0);
        const jumlahHariKerja = aktivitasMingguIni.length;
        const rataRataPekerjaPerHari = jumlahHariKerja > 0
            ? Math.round(totalPekerjaMingguIni / jumlahHariKerja)
            : 0;
        const totalBiayaMingguIni = aktivitasMingguIni.reduce((sum, a) => sum + a.totalBiayaPekerja + a.totalBiayaMaterial, 0);
    ...
    static async getAsistenDashboard() {
        ...
        return {
            ...
            keuanganMingguIni: {
                ...
                totalBiaya: (keuanganMingguIni._sum.totalBiayaPekerja || 0) +
...
//# sourceMappingURL=DashboardUseCase.js.map